...
public class ViewCompat
{
  ...
  static class Api24ViewCompatImpl extends ViewCompat.MarshmallowViewCompatImpl
  {
    public void setPointerIcon(View paramView, PointerIconCompat paramPointerIconCompat)
    {
      ...
      {
        ViewCompatApi24.setPointerIcon(paramView, localObject);
        return;
      }
    }
  }
    ...
    implements ViewCompat.ViewCompatImpl
  {
    ...
    {
      // Byte code:
      //   0: getstatic 322	android/support/v4/view/ViewCompat$BaseViewCompatImpl:sChildrenDrawingOrderMethod	Ljava/lang/reflect/Method;
      //   3: ifnonnull +37 -> 40
      //   6: iconst_1
      //   7: anewarray 30	java/lang/Class
      //   10: astore 14
      //   12: aload 14
      //   14: iconst_0
      //   15: getstatic 328	java/lang/Boolean:TYPE	Ljava/lang/Class;
      //   18: aastore
      //   19: ldc_w 330
      //   22: ldc_w 331
      //   25: aload 14
      //   27: invokevirtual 34	java/lang/Class:getDeclaredMethod	(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
      //   30: putstatic 322	android/support/v4/view/ViewCompat$BaseViewCompatImpl:sChildrenDrawingOrderMethod	Ljava/lang/reflect/Method;
      //   33: getstatic 322	android/support/v4/view/ViewCompat$BaseViewCompatImpl:sChildrenDrawingOrderMethod	Ljava/lang/reflect/Method;
      //   36: iconst_1
      //   37: invokevirtual 335	java/lang/reflect/Method:setAccessible	(Z)V
      //   40: getstatic 322	android/support/v4/view/ViewCompat$BaseViewCompatImpl:sChildrenDrawingOrderMethod	Ljava/lang/reflect/Method;
      //   43: astore 9
      //   45: iconst_1
      ...
      //   53: iconst_0
      //   54: iload_2
      //   55: invokestatic 339	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
      //   58: aastore
      //   59: aload 9
      //   61: aload_1
      //   62: aload 10
      //   64: invokevirtual 104	java/lang/reflect/Method:invoke	(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
      //   67: pop
      //   68: return
      //   69: astore 12
      //   71: ldc 44
      //   73: ldc_w 341
      //   76: aload 12
      //   78: invokestatic 52	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
      //   81: pop
      //   82: goto -49 -> 33
      //   85: astore 7
      //   87: ldc 44
      //   89: ldc_w 343
      //   92: aload 7
      //   94: invokestatic 52	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
      //   97: pop
      //   98: return
      //   99: astore 5
      //   101: ldc 44
      //   103: ldc_w 343
      //   106: aload 5
      //   108: invokestatic 52	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
      //   111: pop
      //   112: return
      //   113: astore_3
      //   114: ldc 44
      //   116: ldc_w 343
      //   119: aload_3
      //   120: invokestatic 52	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
      //   123: pop
      //   124: return
      //
      // Exception table:
  ...
  static class LollipopViewCompatImpl extends ViewCompat.KitKatViewCompatImpl
  {
    ...
    public void setOnApplyWindowInsetsListener(View paramView, OnApplyWindowInsetsListener paramOnApplyWindowInsetsListener)
    {
      ...
      ViewCompatLollipop.setOnApplyWindowInsetsListener(paramView, new ViewCompatLollipop.OnApplyWindowInsetsListenerBridge(paramOnApplyWindowInsetsListener)
      {
        public Object onApplyWindowInsets(View paramView, Object paramObject)
        {
          WindowInsetsCompat localWindowInsetsCompat = WindowInsetsCompat.wrap(paramObject);
          return WindowInsetsCompat.unwrap(this.val$listener.onApplyWindowInsets(paramView, localWindowInsetsCompat));
        }
      });
    }
