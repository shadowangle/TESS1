...
public final class ViewPropertyAnimatorCompat
{
    ...
    implements ViewPropertyAnimatorCompat.ViewPropertyAnimatorCompatImpl
  {
      ...
      implements Runnable
    {
      ...
      Starter(ViewPropertyAnimatorCompat paramView, View arg3)
      {
        Object localObject;
  ...
  static class ICSViewPropertyAnimatorCompatImpl extends ViewPropertyAnimatorCompat.BaseViewPropertyAnimatorCompatImpl
  {
      ...
      implements ViewPropertyAnimatorListener
    {
      ...
      public void onAnimationEnd(View paramView)
      {
        ...
        label115: for (ViewPropertyAnimatorListener localViewPropertyAnimatorListener = (ViewPropertyAnimatorListener)localObject; ; localViewPropertyAnimatorListener = null)
        {
          if (localViewPropertyAnimatorListener != null)
            localViewPropertyAnimatorListener.onAnimationEnd(paramView);
