  ...
  implements Animatable
{
  ...
  private int evaluateColorChange(float paramFloat, int paramInt1, int paramInt2)
  {
    ...
    return j + (int)(paramFloat * ((0xFF & i1 >> 24) - j)) << 24 | k + (int)(paramFloat * ((0xFF & i1 >> 16) - k)) << 16 | m + (int)(paramFloat * ((0xFF & i1 >> 8) - m)) << 8 | n + (int)(paramFloat * ((i1 & 0xFF) - n));
  }
  ...
  private void setupAnimators()
  {
    ...
    1 local1 = new Animation(localRing)
    {
      public void applyTransformation(float paramFloat, Transformation paramTransformation)
      {
        ...
        if (paramFloat <= 0.5F)
        {
          float f8 = paramFloat / 0.5F;
          float f9 = MaterialProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation(f8);
          this.val$ring.setStartTrim(f3 + f9 * (0.8F - f1));
        }
        if (paramFloat > 0.5F)
        {
          float f6 = (paramFloat - 0.5F) / 0.5F;
          float f7 = MaterialProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation(f6);
          this.val$ring.setEndTrim(f2 + f7 * (0.8F - f1));
        }
        this.val$ring.setRotation(f4 + 0.25F * paramFloat);
        float f5 = MaterialProgressDrawable.this.mRotationCount / 5.0F;
        MaterialProgressDrawable.this.setRotation(216.0F * paramFloat + f5 * 1080.0F);
      }
    };
