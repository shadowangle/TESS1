...
class ActivityCompatApi23
{
  ...
  private static class SharedElementCallbackImpl extends SharedElementCallback
  {
    ...
    {
      this.mCallback.onSharedElementsArrived(paramList, paramList1, new ActivityCompatApi23.OnSharedElementsReadyListenerBridge(paramOnSharedElementsReadyListener)
      {
