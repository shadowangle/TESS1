...
public class NotificationCompat
{
  ...
  public static class Action extends NotificationCompatBase.Action
  {
    ...
    public static final NotificationCompatBase.Action.Factory FACTORY = new NotificationCompatBase.Action.Factory()
    {
      ...
      {
        return new NotificationCompat.Action(paramInt, paramCharSequence, paramPendingIntent, paramBundle, (RemoteInput[])(RemoteInput[])paramArrayOfRemoteInput, paramBoolean);
      }
    ...
    implements NotificationCompat.NotificationCompatImpl
  {
    public Notification build(NotificationCompat.Builder paramBuilder, NotificationCompat.BuilderExtender paramBuilderExtender)
    {
      Notification localNotification = NotificationCompatBase.add(paramBuilder.mNotification, paramBuilder.mContext, paramBuilder.resolveTitle(), paramBuilder.resolveText(), paramBuilder.mContentIntent, paramBuilder.mFullScreenIntent);
  ...
  static class NotificationCompatImplJellybean extends NotificationCompat.NotificationCompatImplBase
  {
    public Notification build(NotificationCompat.Builder paramBuilder, NotificationCompat.BuilderExtender paramBuilderExtender)
    {
      ...
      if (paramBuilder.mStyle != null)
      {
        Bundle localBundle = getExtras(localNotification);
        if (localBundle != null)
