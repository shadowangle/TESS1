...
public final class MediaControllerCompat
{
    ...
    implements MediaControllerCompat.MediaControllerImpl
  {
    ...
    private class ExtraCallback extends IMediaControllerCallback.Stub
    {
      ...
      ExtraCallback(MediaControllerCompat.Callback arg2)
      {
        Object localObject;
      ...
      public void onEvent(String paramString, Bundle paramBundle)
        throws RemoteException
      {
        this.mCallback.mHandler.post(new Runnable(paramString, paramBundle)
        {
          public void run()
          {
            MediaControllerCompat.MediaControllerImplApi21.ExtraCallback.this.mCallback.onSessionEvent(this.val$event, this.val$extras);
          }
        });
      }
      ...
      public void onPlaybackStateChanged(PlaybackStateCompat paramPlaybackStateCompat)
        throws RemoteException
      {
        this.mCallback.mHandler.post(new Runnable(paramPlaybackStateCompat)
        {
          public void run()
          {
            MediaControllerCompat.MediaControllerImplApi21.ExtraCallback.this.mCallback.onPlaybackStateChanged(this.val$state);
          }
        });
      }
